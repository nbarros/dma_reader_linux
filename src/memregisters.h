...
// These are the addresses where shows in xparameters.h
#define MEMORY_MAPPER_BASEADDR 0x43C20000
#define MEMORY_MAPPER_HIGHADDR 0x43C2FFFF

#define CONFIG_MANAGER_BASEADDR 0x43C00000
#define CONFIG_MANAGER_HIGHADDR 0x43C0FFFF
